            ...
            if p[1] == 'END':
                ...
                if LASTHEARD_INC:
                   if int(float(p[9]))> 2: 
                      ...
                      f.write("<TR style=\" height: 32px;font: 10pt arial, sans-serif; background-color:#2A659A; color:white\"><TH>Date</TH><TH>Time</TH><TH>Callsign (DMR-Id)</TH><TH>Name</TH><TH>TG#</TH><TH>TG Name</TH><TH>TX (s)</TH><TH>Slot</TH><TH>Source ID</TH><TH>System</TH></TR>\n")
